...
from deadline.job_attachments.models import JobAttachmentS3Settings, ManifestDiff
...
def manifest_upload(
    ...
    **args,
    ...
    if not s3_cas_uri:
        ...
        manifest_path = queue_ja_settings.rootPrefix
        ...
        manifest_path = uri_ja_settings.rootPrefix
