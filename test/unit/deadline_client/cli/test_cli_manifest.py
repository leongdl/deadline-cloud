...
def mock_hash_attachments():
    with patch.object(api, "_hash_attachments", return_value=(Mock(), [])) as mock:
        yield mock
...
class TestUpload:
    ...
    def test_upload_valid_manifest(
        ...
        with patch.object(_submit_job_bundle.api, "get_boto3_client"), patch.object(
            ...
            manifest_group, "read_local_manifest", return_value=basic_asset_manifest
        ), patch.object(
            manifest_group, "diff_manifest", return_value=[]
        ), patch.object(
    ...
    def test_upload_invalid_manifest_dir(fresh_deadline_config):
        ...
        """
        with patch("deadline.client.cli._groups.manifest_group.os.path.isdir", return_value=False):
    ...
    def test_upload_with_update(
        ...
        with patch.object(_submit_job_bundle.api, "get_boto3_client"), patch.object(
            ...
            manifest_group, "diff_manifest", return_value=["/path/to/modified/file.txt"]
        ), patch.object(
            S3AssetUploader, "_write_local_manifest_s3_mapping"
        ) as mock_write_manifest_mapping:
    ...
    def test_upload_with_modified_files_without_update(fresh_deadline_config, mock_init_objects):
        ...
        with patch.object(_submit_job_bundle.api, "get_boto3_client"), patch.object(
            ...
            manifest_group, "diff_manifest", return_value=mock_modified_files
        ):
    ...
    def test_cli_asset_upload_read_local_manifest_returns_none(
        ...
        with patch.object(_submit_job_bundle.api, "get_boto3_client"), patch.object(
            ...
            manifest_group, "read_local_manifest", return_value=None
        ):
...
class TestDiff:
    ...
    def run_test_case(
        ...
        with patch.object(os.path, "isdir", side_effect=[True, True]), patch.object(
            manifest_group, "HashCache", return_value=mock_cachedb
        ), patch.object(
            manifest_group,
            "compare_manifest",
            return_value=[
